...
$(function () {
    ...
    function topColor() {
        ...
        setInterval(function () {
            $(ele[i]).find('.cicle').css({
                'background': 'url(./echart/orange.png) no-repeat center',
                'backgroundSize': '100%'
            })
            $(ele[i]).find('.li-content').css({
                'background': 'url(./echart/border2.png) no-repeat center',
                'backgroundSize': 'contain'
            })
            $(ele[i]).siblings().find('.cicle').css({
                'background': 'url(./echart/green.png) no-repeat center',
                'backgroundSize': '100%'
            })
            $(ele[i]).siblings().find('.li-content').css({
                'background': 'url(./echart/border.png) no-repeat center',
                'backgroundSize': 'contain'
            })
            i++
            if (i == length) {
            ...
            series: [{
                ...
                label: {
                    normal: {
                        ...
                        formatter: function () {
                            if (ele=='.chart1'){
                                return (radius_data[0] * 100).toFixed(2) + '%';
                            }else{
                                return (radius_data[1] * 100).toFixed(2) + '%';
                            }
                        },
                        textStyle: {
                            fontSize: 0.5 * w,
    ...
    // draw('.shoeChart', draw_data[0][1], '完成率', draw_data[0][2], '#09c4ca')
    // draw('.clothesChart', draw_data[1][1], '完成率', draw_data[1][2], '#09c4ca')
    // draw('.mzChart', draw_data[2][1], '完成率', draw_data[2][2], '#09c4ca')
    draw('.shoeChart', draw_data[0][1], '', draw_data[0][2], '#09c4ca')
    draw('.clothesChart', draw_data[1][1], '', draw_data[1][2], '#09c4ca')
    draw('.mzChart', draw_data[2][1], '', draw_data[2][2], '#09c4ca')
